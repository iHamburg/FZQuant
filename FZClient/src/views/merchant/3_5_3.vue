    ...
    data () {
      return {
        ...
        datas: [ // 店长菜单
          ...
          {"imgUrl": "../static/images/xqls3.png", "describe": "优惠券核销清单", "name": '6.9.5', "show": 1, count: 0},
          {"imgUrl": "../static/images/xqls3.png", "describe": "提货码核销清单", "name": '3.5.1', "show": 1, count: 0},
        ],
      }
    },
    mixins: [uiMixin],
