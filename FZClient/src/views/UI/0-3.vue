...
<template>
    <div class="user-content write">
      <bl-bar barStyle="bar-dark-write">
          ...
          <div slot="right-button" class="hrad-right">已有账号</div>
      </bl-bar>
      ...
      <section class="user">
          ...
          <p class="reg"><i class="checkbox" :class="{'sure':isSure}" @click="isSure = !isSure"></i>已阅读并同意 <span class="blue">《百联会员注册协议》</span></p>
          
          <bl-button class="loginbtn" @click="register"><img src="../../sass/base64/loading.png" class="loading" v-show="loading">注 册</bl-button>
...
<script type="text/babel">
  export default {
    ...
    methods: {
      ...
      register() {
        this.loading = true
        if (this.isSure) this.$toast('注册成功')
      }
    }
  }
</script>
