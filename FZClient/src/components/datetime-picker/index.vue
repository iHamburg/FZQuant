<template>
  <mt-popup v-model="visible" position="bottom" class="popup-discount" style="width: 100%;">
    <bl-picker :slots="dateSlots" @change="onChange" :visible-item-count="5" class="bl-datetime-picker"
     ref="picker" show-toolbar @cancel="close" @getValues="confirm">
      ...
      <div class="toolbar-text hairline">{{ toolbarSubText }}</div>
    </bl-picker>
  </mt-popup>
</template>
...
<style lang="css">
  ...
  .toolbar-head{
    overflow: hidden;
    height: 50px;
    border-bottom: solid 6px #EFEFF4;
  }
  .toolbar-text{
    height: 50px;
    line-height: 50px;
