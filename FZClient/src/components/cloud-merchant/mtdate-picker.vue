<template>
  <mt-popup v-model="visible" position="bottom" class="bl-datetime" style="width:100%">
    <bl-picker
      :slots="dateSlots"
      @change="onChange"
  ...
  export default {
    ...
    methods: {
      ...
      handleExceededValue() {
        ...
        // console.log('handleExceededValue values:', values)
      },
      ...
      init() {
        ...
        // console.log('init currentValue:', this.currentValue);
        this.generateSlots();
      }
    },
    ...
    watch: {
      ...
      defaultDate() {
        // console.log('变了', this.defaultDate)
        this.init()
      },
    },
