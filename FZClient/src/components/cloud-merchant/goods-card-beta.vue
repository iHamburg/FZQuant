<template>
  <div class="coupon-card" :class="{ 'lose-effect': isFailure }">
    ...
    <div class="coupon-logo">
      ...
      <div class="logo-box">
        <div class="coupon-type flex-c">{{stateName(propsData.goodsState,propsData.stockState)}}</div>
        <div class="listImg"><img :src="propsData.goodsImg"></div>
      </div>
    </div>
    <div class="coupon-title flex-c-m" v-if="isCouponName">{{ propsData.goodsName }}</div>
    ...
    <div class="coupon-suggest">
      <div class="coupon-text">货号：{{ propsData.freightNo }}</div>
      <!-- <div class="scope-of">适用范围：礼品券Test耶里夏利</div> -->
    </div>
    <div class="coupon-body flex-m">
      <div class="coupon-body-item">
        <p class="cate">吊牌价</p>
        <p>{{ propsData.tagPrice }}元</p>
      </div>
      <div class="coupon-body-item">
        <p class="cate">售价</p>
        <p>{{ propsData.price }}元</p>
      </div>
      <div class="time coupon-body-item">
        <p class="cate">{{ propsData.beginAt }}</p>
        <p>{{ propsData.endAt }}</p>
      </div>
    </div>
...
export default {
  ...
  methods: {
    stateName (goodsState, stockState) {
      let stateName = '';
      if (goodsState == 2 && stockState == 1) {
        stateName = '有货'
      } else if (goodsState == 2 && stockState == 0) {
        stateName = '无货'
