...
import pandas as pd
# import pyquant.strategies.entermarketstrategy as
from  pyquant.strategies.crossover import CrossOver
import datetime
...
datapath = '../datas/index/000001.csv'
...
cerebro.addstrategy(CrossOver,fast=10,slow=20)
